...
from app.routers import auth, users, vehicles, bookings, payments, admin, reviews, documents, disputes, vehicle_images
...
app.include_router(vehicle_images.router, prefix='/api/vehicle-images', tags=['Vehicle Images'])
